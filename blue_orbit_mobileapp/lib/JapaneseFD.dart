...
class japaneseFD extends StatefulWidget {
  const japaneseFD({super.key});

  @override
  State<japaneseFD> createState() => _japaneseFDState();
}

class _japaneseFDState extends State<japaneseFD> {
  @override
